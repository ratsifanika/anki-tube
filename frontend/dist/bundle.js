...
let MainApp = class MainApp extends i {
    render() {
        return x `<p>
...
MainApp.styles = i$3 `p { color: red }
              other-part {color: blue}`;
MainApp = __decorate([
    t('main-app')
], MainApp);

class Part extends i {
    render() {
        return x `<div>coucou I'm part</div>`;
    }
}
